...
public class JsoniqLanguageServer implements LanguageServer, LanguageClientAware {
    private TextDocumentService textDocumentService;
    private WorkspaceService workspaceService;
    private LanguageClient client;
    private int errorCode = 1;

    public JsoniqLanguageServer() {
        this.textDocumentService = new JsoniqTextDocumentService();
        this.workspaceService = new JsoniqWorkspaceService();
    }
